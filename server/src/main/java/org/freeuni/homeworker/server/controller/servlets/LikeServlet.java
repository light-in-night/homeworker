...
@WebServlet("/hasSession/isLoggedIn//likeServlet")
public class LikeServlet extends HttpServlet {

	private static final Logger log = LoggerFactory.getLogger(LikeServlet.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(likeModuleManager.hasLiked(userId , postId)){
				resp.setMessage("Has Liked");
				resp.setStatus(ResponseStatus.OK.name());
				resp.setLiked(true);

			} else {
				resp.setLiked(false);
				resp.setMessage("Has Not Liked");
				resp.setStatus(ResponseStatus.OK.name());
			}
