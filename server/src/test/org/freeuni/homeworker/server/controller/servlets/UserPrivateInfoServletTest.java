...
public class UserPrivateInfoServletTest {
    @Mock
    ...
    private UserPrivateInfoServlet userPrivateInfoServlet;
    ...
    public void setUp() throws SQLException, InterruptedException, IOException {
        userPrivateInfoServlet = new UserPrivateInfoServlet();
    ...
    public void doGetIsValid() throws SQLException, InterruptedException, ServletException, IOException {
        ...
        setSessionParams(userId, testSessionId,
                true, true);

        userPrivateInfoServlet.doGet(request, response);

        JsonNode responseNode = objectMapper.readTree(resultingJSON);
        assertEquals("test pass", responseNode
                .get("password")
                .asText());
    }
