...
public class UserModifyServletTest  {
    @Mock
    ...
    private UserModifyServlet userModifyServlet;
    ...
    public void setUp() throws SQLException, InterruptedException, IOException {
        userModifyServlet = new UserModifyServlet();
...
//        assertFalse(responseNode.get("isValid").asBoolean());
    ...
    @Test
    public void doPutFail() throws IOException, SQLException, InterruptedException, ServletException {
