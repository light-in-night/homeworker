...
public class CommentAccessServletTest {
    @Mock
    ...
    private CommentAccessServlet commentAccessServlet;
    ...
    public void setUp() throws SQLException, InterruptedException, IOException {
        commentAccessServlet = new CommentAccessServlet();
    ...
    @Test
    public void doGet() throws IOException, SQLException, InterruptedException, ServletException {
        //inputString = " { \"id\" : 1 } ";
        ...
        commentAccessServlet.doGet(request, response);
